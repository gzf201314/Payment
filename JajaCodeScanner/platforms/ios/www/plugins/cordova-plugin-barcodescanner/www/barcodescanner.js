 ...
 */
    ...
    var ScannerLoader = function (require, exports, module) {
        ...
        * 
        * @param {String}   data 用来在二维码扫码视图中显示
        *
        ...
        */
       BarcodeScanner.prototype.scanDesc = function (message,successCallback, errorCallback) {
       ...
       exec(successCallback, errorCallback, 'BarcodeScanner', 'scandesc', [message]);
       };
